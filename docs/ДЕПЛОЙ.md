...
Если хотите включить аналитику, добавьте переменную:

- `VITE_YM_COUNTER_ID` — ID счётчика Метрики (только цифры)

Подробная инструкция (локально + Vercel): см. [ENV_SETUP.md](./ENV_SETUP.md)
