      ...
      >
        ...
        >
          <p className="conclusion-card-text">
            Лид-магнит открыл дверь. Теперь, когда клиент получил первую пользу бесплатно, система автоматически предлагает сделать следующий шаг — Трипвайер (продукт с импульсивной покупкой).
          </p>
          <div className="output-card-buttons">
            <button 
              className="output-next-stage-btn"
  ...
  const tripwireContent = (
    <div className="tripwire-new-container">
            ...
            <div className="result-metrics">
              <div className="result-metric">
                ...
                <div className="metric-content">
                  ...
                  <div className="metric-description">Трипвайер подтверждает экономическую жизнеспособность вашей воронки: вы видите реальную стоимость привлечения, конверсию в первую покупку и ROI на каждом этапе. Это не гипотеза — это работающая модель монетизации с конкретными цифрами и прогнозируемым результатом.</div>
                </div>
              </div>
              <div className="result-metric">
                <span className="metric-icon">🎯</span>
      ...
      >
        ...
        >
          <p className="conclusion-card-text">
            Трипвайер завершает критический переход: из читателя клиент превращается в <strong>реального покупателя</strong>. 
      ...
      >
        ...
        <div className="product-input-cards">
          ...
          >
            ...
            <div className="input-card-content">
              <p className="input-card-description">
                Клиент, который уже прошёл всю воронку: получил лид-магнит, купил трипвайер, прошёл автоворонку прогрева. 
