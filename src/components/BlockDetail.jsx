        ...
        <div className="audience-intro-layout">
          <div className="audience-intro-text">
            ...
            <ul style={{ marginTop: '0.5rem', marginBottom: '1rem' }}>
              <li><strong>1️⃣ Тестовый</strong> — проверяем гипотезы и принимаем управленческое решение;</li>
              <li><strong>2️⃣ Рабочий</strong> — фиксируем подтверждённые сегменты и готовим переход к воронке.</li>
            </ul>
          </div>
