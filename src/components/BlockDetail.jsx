  ...
  const audienceContent = (
    <div className="block-detail-sections">
      ...
      <section className="block-detail-section">
        ...
        <p>На этапе «Аудитория» продукт существует только как гипотеза (проблема, результат, формат, цена, аудитория), без создания финальной версии — уроки, платформы, лендинги и воронки создаются только после подтверждения гипотезы.</p>
      </section>
