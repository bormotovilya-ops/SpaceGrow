...
const stages = [
  ...
  },
  {
    ...
    questions: [
      {
        id: 'tripwire_1',
        text: 'Есть ли у вас трипваер (первая импульсивная покупка) после лидмагнита?'
      },
      {
        id: 'tripwire_2',
        text: 'Насколько трипваер логично вытекает из лидмагнита?'
      },
      {
        id: 'tripwire_3',
        text: 'Конвертируется ли трипваер в первую покупку стабильно?'
      }
    ]
  },
  {
