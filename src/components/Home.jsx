  ...
  const faqItems = [
    {
      ...
      answer: 'От 2 до 6 недель в зависимости от сложности вашей воронки. Простые автоматизации запускаются за 2 недели, комплексные системы с интеграциями — до 6 недель.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Стоимость зависит от масштаба проекта. После бесплатной диагностики вы получите точный расчет. В среднем инвестиции окупаются за 1-3 месяца работы системы.'
    }
  ]
              ...
              <div className="home-hero-value">
                ...
                <div className="home-hero-subtitle">
                  <p className="subtitle-paragraph">
                    Бизнес — это эскалатор, идущий вниз: чтобы расти, нужно быть быстрее потока.
                  </p>
                  <p className="subtitle-paragraph">
                    Мы находим «протечки» в вашей автоматизации и внедряем IT-решения нового поколения 
                    <span className="tech-highlight"> (ИИ, Боты, MiniAPP и др.)</span>.
                  </p>
                  <p className="subtitle-paragraph subtitle-highlight">
                    Превратите привычную стабильность в управляемый взлет до <strong>1–2 млн ₽ в месяц и выше.</strong>
                  </p>
                </div>
              </div>
            </div>
