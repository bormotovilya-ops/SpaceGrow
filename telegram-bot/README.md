# Telegram-бот для SpaceGrowth MiniApp

Бот открывает сайт SpaceGrowth как MiniApp в Telegram.
...
2. Отправьте `/start`
3. Должна появиться кнопка "🚀 Открыть SpaceGrowth"
...
6. Введите текст кнопки: `Открыть SpaceGrowth`
