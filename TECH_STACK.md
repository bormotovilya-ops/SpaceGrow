...
Краткий список основных технологий и внешних сервисов, которые используются в проекте "Пространство развития". Разбит по слоям: фронтенд, бэкенд, БД, боты и инфраструктура.
